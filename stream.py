...
def introduction():
    ...
    st.header('Kullanıcı Etkileşimi')
    col1, col2, col3, col4 = st.columns([1, 1, 1, 1])
    col1.selectbox('Bir ülke seçiniz: ', ['USA', 'Germany', 'Japan', 'Italy', 'France', 'Spain', 'Australia', 'Canada'])
    col2.checkbox('Veriyi Göster:', value=False)
    col3.radio('Bir araba modeli seçiniz:', ('BMW', 'Mercedes', 'Audi', 'Toyota', 'Honda', 'Nissan', 'Mazda', 'Ford'))
    col4    .date_input('Bir tarih seçiniz:', value=pd.to_datetime('2020-01-01'))
    st.header('Örnek Proje')
